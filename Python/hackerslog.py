b = input("Please enter the sipher key: ")
if b == 9999:
    ...
    if a == 110318:
        ...
        print "Hi once again, I'm back."
        print """
        So I have been reintroducing myself to html and css and developing a site for my personal use.  """
    else:
        time.sleep(3)
        print "...."
        time.sleep(2)
    ...
    print "...."
    print "Sorry, ", b, "is the wrong key"
